...
class ConsenSolution: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {

    @IBOutlet weak var concentrationTextField: UITextField!
    @IBOutlet weak var unitPickerView: UIPickerView!
    @IBOutlet weak var resultLabel: UILabel!
    
    let concentrationUnits = ["Molarity", "Percent", "Molality", "Mass Fraction", "Volume Fraction"]
